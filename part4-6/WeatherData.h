...
private:
	...
	void Update(SWeatherInfo const& data, const CObservable<SWeatherInfo>* observable) override
	{
        ...
        if (observable == m_weatherDataIn)
        {
            ...
            std::cout << "Temperature Stats: Max " << m_temperatureStatsInside.GetMax()
    ...
    CStatistics m_temperatureStatsInside;
    CStatistics m_humidityStatsInside;
    CStatistics m_pressureStatsInside;

    CStatistics m_temperatureStatsOutside;
    CStatistics m_humidityStatsOutside;
    CStatistics m_pressureStatsOutside;
